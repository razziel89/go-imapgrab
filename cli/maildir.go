...
var maildirConf maildirConfigT

type maildirConfigT struct {
	path string
}

func init() {
	rootCmd.AddCommand(maildirCmd)
}

var maildirCmd = &cobra.Command{
	Use:   "maildir",
	Short: "Manage your local maildir.",
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cfg := core.IMAPConfig{
			...
			// Password is not needed here and thus not passed on.
		}
		return core.ReadMaildir(cfg, maildirConf.path)
	},
}
...
func initMaildirFlags() {
	pflags := maildirCmd.PersistentFlags()
