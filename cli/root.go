...
const (
	...
	typicalFlowHelp = "" +
		"A typical run of go-imapgrab consists of 3 separate invocations. First, you store your\n" +
		"credentials in your system's keyring using the \"login\" command. Then, you list all\n" +
		"folders in your inbox using the \"list\" command. Last but not least, you download all\n" +
		"emails from all folders that you wish to back up. For future runs in order to \n" +
		"download new emails, run the exact same \"download\" command again.\n\n" +
